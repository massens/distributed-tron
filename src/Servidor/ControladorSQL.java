...
public class ControladorSQL implements Observer{
    ...
    public  void addScore(Connection con, int[] scores) throws SQLException{
    ...
    public void asegurarTaulaExisteix(Connection con, String table) throws SQLException{
    ...
    public  void crearTaula(Connection con, String table) throws SQLException{
